...
- On the **gateway host**:
  - Store file: `~/.joni/agents/<agentId>/sessions/sessions.json` (per agent).
- Transcripts: `~/.joni/agents/<agentId>/sessions/<SessionId>.jsonl` (Telegram topic sessions use `.../<SessionId>-topic-<threadId>.jsonl`).
