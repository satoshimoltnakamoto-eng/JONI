  ...
  if (!opts.skipUi && gatewayProbe.ok) {
    ...
    await prompter.note(
      [
        ...
        `Generate token: ${formatCliCommand("joni doctor --generate-gateway-token")}`,
  ...
  await prompter.note(
    hasWebSearchKey
      ...
      : [
          ...
          "",
          "JONI uses Brave Search for the `web_search` tool. Without a Brave Search API key, web search won’t work.",
          "",
          "Set it up interactively:",
          `- Run: ${formatCliCommand("joni configure --section web")}`,
