...
const FIELD_HELP: Record<string, string> = {
  ...
  "diagnostics.cacheTrace.filePath":
    "JSONL output path for cache trace logs (default: $JONI_STATE_DIR/logs/cache-trace.jsonl).",
  ...
  "agents.defaults.memorySearch.store.path":
    "SQLite index path (default: ~/.joni/memory/{agentId}.sqlite).",
  ...
  "plugins.installs.*.installPath": "Resolved install directory (usually ~/.joni/extensions/<id>).",
