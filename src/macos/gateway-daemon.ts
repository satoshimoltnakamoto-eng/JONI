...
declare const __JONI_VERSION__: string | undefined;

const BUNDLED_VERSION =
  (typeof __JONI_VERSION__ === "string" && __JONI_VERSION__) ||
  process.env.JONI_BUNDLED_VERSION ||
  "0.0.0";
