...
const execHostEnforced = process.env.JONI_NODE_EXEC_HOST?.trim().toLowerCase() === "app";
const execHostFallbackAllowed = process.env.JONI_NODE_EXEC_FALLBACK?.trim().toLowerCase() !== "0";
