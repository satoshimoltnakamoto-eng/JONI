const DEFAULT_TAGLINE = "Deploy AI agents autonomously with crypto-powered infrastructure.";
...
const TAGLINES: string[] = [
  ...
  "Autonomous agent deployment - no humans required (after setup).",
...
export function pickTagline(options: TaglineOptions = {}): string {
  ...
  const override = env?.JONI_TAGLINE_INDEX;
